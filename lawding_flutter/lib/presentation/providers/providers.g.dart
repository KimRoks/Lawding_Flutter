...
/// See also [annualLeaveRepository].
...
/// See also [leavePolicyRepository].
...
/// See also [leaveDashboardRepository].
...
/// See also [calculateAnnualLeaveUseCase].
...
/// See also [submitFeedbackUseCase].
...
/// See also [getDictionariesUseCase].
...
/// See also [searchDictionaryUseCase].
...
/// See also [getCalendarEventsUseCase].
...
/// See also [getCalendarEventUseCase].
...
/// See also [createCalendarEventUseCase].
...
/// See also [updateCalendarEventUseCase].
...
/// See also [deleteCalendarEventUseCase].
...
/// See also [submitLeavePolicyUseCase].
...
/// See also [getLeaveDashboardUseCase].
...
String _$getUserMeUseCaseHash() => r'6103a9217d8598612aada394b409391d50523d57';

/// GetUserMeUseCase Provider
/// 내 전체 정보 조회 비즈니스 로직 제공 (유저 + 연차 정책 + 연차 잔여)
///
/// Copied from [getUserMeUseCase].
@ProviderFor(getUserMeUseCase)
final getUserMeUseCaseProvider = AutoDisposeProvider<GetUserMeUseCase>.internal(
  getUserMeUseCase,
  name: r'getUserMeUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getUserMeUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef GetUserMeUseCaseRef = AutoDisposeProviderRef<GetUserMeUseCase>;
