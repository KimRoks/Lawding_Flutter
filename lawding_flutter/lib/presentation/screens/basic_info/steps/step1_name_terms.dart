...
class Step1Data {
  ...
  const Step1Data({required this.nickname, required this.acceptedTerms});
}

class Step1NameTerms extends StatefulWidget {
  final void Function(bool canProceed) onValidChanged;
  final void Function(Step1Data)? onDataChanged;

  const Step1NameTerms({
    super.key,
  ...
  @override
  State<Step1NameTerms> createState() => _Step1NameTermsState();
}
...
class _Step1NameTermsState extends State<Step1NameTerms> {
  ...
  void _notify() {
    ...
    if (_isValid) {
      widget.onDataChanged?.call(Step1Data(
